//Fungsi pergerakan object menggunakan mouse/keyboard 
...
Fungi.KBMCtrl_Viewport = class{
	...
	onKeyDown(e,ctrl,keyCode){
		switch(keyCode){		
			case 87: this.camera.position.z -= 2 * this.zPanRate; break;	//W zoom in
			case 83: this.camera.position.z += 2 * this.zPanRate; break;	//S zoom out
			case 65: this.camera.position.x -= 50 * this.xPanRate; break;	//A geser kiri
			case 68: this.camera.position.x += 50 * this.xPanRate; break;	//D geser kanan
			case 81: this.camera.euler.y += 10 * this.yRotRate; break;		//Q putar kiri
			case 69: this.camera.euler.y -= 10 * this.yRotRate; break;		//E putar kanan 
		}
	}
}